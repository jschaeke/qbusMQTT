...
#Installation
Install perl with all the necessary dependencies (TODO for me to add here), create a qbusMQTT.ini with the properties of the MQTT broker (e.g. Mosquitto) and Eqoweb.
